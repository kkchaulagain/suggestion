...
export default function Login(): JSX.Element {
  ...
  return (
    <div className="relative min-h-screen overflow-y-auto bg-[radial-gradient(55rem_28rem_at_90%_-20%,#c8efe3_5%,transparent_65%),radial-gradient(42rem_25rem_at_-10%_120%,#ffcfa6_5%,transparent_65%),linear-gradient(140deg,#fffdf8_0%,#f5fbff_100%)] dark:bg-[radial-gradient(55rem_28rem_at_90%_-20%,rgba(45,212,191,0.12)_5%,transparent_65%),linear-gradient(140deg,#0f172a_0%,#1e293b_100%)] px-4 py-6 sm:px-6 sm:py-8 grid place-items-center">
      <div className="absolute right-4 top-4">
        <ThemeToggle />
      </div>
      <div className="w-full max-w-[460px] rounded-2xl border border-teal-700/20 bg-gradient-to-b from-white to-amber-50 dark:border-slate-700 dark:from-slate-800 dark:to-slate-900 p-4 sm:p-6 md:p-8 shadow-[0_30px_50px_-32px_rgba(19,49,84,0.32)]">
        ...
        <form className="grid gap-4" onSubmit={handelFromSubmit} noValidate>
          <Input
            id="login-email"
            label="Email"
            type="email"
