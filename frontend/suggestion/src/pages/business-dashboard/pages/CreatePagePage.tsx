...
import { renderBlockPreview } from './pageBlockRenderers'
import { renderBlockFields } from './pageBlockEditors'
import {
  PAGE_TEMPLATES,
      ...
      {editingBlockIndex !== null && blocks[editingBlockIndex] && (
        ...
        >
          <div className="max-h-[70vh] overflow-y-auto pr-1">
            {renderBlockFields(blocks[editingBlockIndex], editingBlockIndex, { updateBlock, formOptions, setUploadTarget })}
          </div>
